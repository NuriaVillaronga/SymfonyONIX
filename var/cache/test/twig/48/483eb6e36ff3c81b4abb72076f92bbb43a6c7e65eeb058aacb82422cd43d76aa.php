...
class __TwigTemplate_65a0d02e6c6622730a86958f4b33dba38cca144855d58578b615d0dce89859b6 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<form method=\"post\" name=\"login_form\" action=\"";
    ...
    <input type=\"hidden\" name=\"_csrf_token\" value=\"";
        ...
        echo "\">
    <button id=\"sign-in\" class=\"btn btn-lg btn-primary\" type=\"submit\">Sign in</button>
...
";
    ...
    {
        return array (  128 => 22,  122 => 19,  117 => 16,  109 => 13,  106 => 12,  104 => 11,  101 => 10,  95 => 8,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
<form method=\"post\" name=\"login_form\" action=\"{{ path('app_login') }}\">
    {% if error %}
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            You are logged in as {{ app.user.username }}, <a id=\"logout\" href=\"{{ path('app_logout') }}\">Logout</a>
        </div>
    {% endif %}
