...
return [
    ...
    'deleteCatalog' => [['id', 'name'], ['_controller' => 'App\\Controller\\DeleteController::deleteCatalog'], [], [['variable', '/', '[^/]++', 'name', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/delete']], [], []],
    ...
    'upload_onix' => [['id', 'name'], ['_controller' => 'App\\Controller\\UploadFileController::index'], [], [['variable', '/', '[^/]++', 'name', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/upload']], [], []],
    'view_catalog' => [['id'], ['_controller' => 'App\\Controller\\ViewCatalogController::view'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/view/catalog']], [], []],
