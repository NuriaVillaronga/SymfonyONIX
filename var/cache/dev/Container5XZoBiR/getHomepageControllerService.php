...
class getHomepageControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.PRCEzdO'] ?? $container->load('get_ServiceLocator_PRCEzdOService'))->withContext('App\\Controller\\HomepageController', $container));
