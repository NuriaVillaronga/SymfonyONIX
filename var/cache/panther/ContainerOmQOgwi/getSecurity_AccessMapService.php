 ...
 */
class getSecurity_AccessMapService extends App_KernelPantherDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/create'), [0 => 'ROLE_ADMIN'], NULL);
