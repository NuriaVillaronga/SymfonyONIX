 ...
 */
class getRouting_LoaderService extends App_KernelPantherDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'panther');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'panther'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'panther'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'panther'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'panther'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'panther'));
